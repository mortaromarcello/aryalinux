...
su - $USERNAME -c "PKG_BUILDER=$1 alps install-no-prompt usbutils pciutils openssh gobject-introspection libxml2 desktop-file-utils nfs-utils shared-mime-info ccache"
