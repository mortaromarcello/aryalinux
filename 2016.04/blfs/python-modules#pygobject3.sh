...
wget -nc ftp://ftp.gnome.org/pub/gnome/sources/pygobject/3.18/pygobject-3.18.2.tar.xz || wget -nc http://ftp.gnome.org/pub/gnome/sources/pygobject/3.18/pygobject-3.18.2.tar.xz
