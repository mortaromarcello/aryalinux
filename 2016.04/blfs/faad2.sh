...
wget -nc http://www.linuxfromscratch.org/patches/downloads/faad2/faad2-2.7-mp4ff-1.patch || wget -nc http://www.linuxfromscratch.org/patches/blfs/systemd/faad2-2.7-mp4ff-1.patch
