...
wget -nc http://www.linuxfromscratch.org/patches/blfs/systemd/docbook-utils-0.6.14-grep_fix-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/docbook-utils/docbook-utils-0.6.14-grep_fix-1.patch
