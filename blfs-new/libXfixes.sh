...
SOURCE_ONLY=n
DESCRIPTION=" The Xorg libXfixes library provide library routines that are used within all X Window applications."
SECTION="x"
VERSION=5.0.3
NAME="libXfixes"
PKGNAME=$NAME
...
function build() {
    ...
    if [ ! -z $URL ]; then
        wget -nc http://ftp.x.org/pub/individual/lib/libXfixes-5.0.3.tar.bz2
