...
SOURCE_ONLY=n
DESCRIPTION=" The Xorg libXScrnSaver library provide library routines that are used within all X Window applications."
SECTION="x"
VERSION=1.2.2
NAME="libXScrnSaver"
PKGNAME=$NAME
...
function build() {
    ...
    if [ ! -z $URL ]; then
        wget http://ftp.x.org/pub/individual/lib/libXScrnSaver-1.2.2.tar.bz2
