...
SOURCE_ONLY=n
DESCRIPTION=" The Xorg libXcomposite library provide library routines that are used within all X Window applications."
SECTION="x"
VERSION=0.4.4
NAME="libXcomposite"
PKGNAME=$NAME
...
function build() {
    ...
    if [ ! -z $URL ]; then
        wget -nc http://ftp.x.org/pub/individual/lib/libXcomposite-0.4.4.tar.bz2
