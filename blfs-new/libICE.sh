...
SOURCE_ONLY=n
DESCRIPTION=" The Xorg libICE library provide library routines that are used within all X Window applications."
SECTION="x"
VERSION=1.0.9
NAME="libICE"
PKGNAME=$NAME
...
function build() {
    ...
    if [ ! -z $URL ]; then
        wget -nc http://ftp.x.org/pub/individual/lib/libICE-1.0.9.tar.bz2
