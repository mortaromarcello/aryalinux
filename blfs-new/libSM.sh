...
SOURCE_ONLY=n
DESCRIPTION=" The Xorg libSM library provide library routines that are used within all X Window applications."
SECTION="x"
VERSION=1.2.2
NAME="libSM"
PKGNAME=$NAME
...
function build() {
    ...
    if [ ! -z $URL ]; then
        wget -nc http://ftp.x.org/pub/individual/lib/libSM-1.2.2.tar.bz2
