...
SOURCE_ONLY=n
DESCRIPTION=" The Xorg libXpm library provide library routines that are used within all X Window applications."
SECTION="x"
VERSION=3.5.2
NAME="libXpm"
PKGNAME=$NAME
...
function build() {
    ...
    if [ ! -z $URL ]; then
        wget -nc http://ftp.x.org/pub/individual/lib/libXpm-3.5.11.tar.bz2
