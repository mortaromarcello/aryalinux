...
SOURCE_ONLY=n
DESCRIPTION=" The Xorg libXfont library provide library routines that are used within all X Window applications."
SECTION="x"
VERSION=1.5.2
NAME="libXfont"
PKGNAME=$NAME
...
function build() {
    ...
    if [ ! -z $URL ]; then
        wget -nc http://ftp.x.org/pub/individual/lib/libXfont-1.5.2.tar.bz2
