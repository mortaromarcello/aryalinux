...
SOURCE_ONLY=n
DESCRIPTION="The Xorg ATI Driver package contains the X.Org Video Driver for ATI Radeon video cards including all chipsets ranging from R100 to R900 and the newer RAxx chipsets."
SECTION="x"
VERSION=7.7.0
NAME="xf86-video-ati"
PKGNAME=$NAME
...
function build() {
    ...
    mkdir -vp $PKG${XORG_PREFIX}/share/X11/xorg.conf.d/
    cat >> $PKG${XORG_PREFIX}/share/X11/xorg.conf.d/20-glamor.conf << "EOF"
Section "Device"
        Identifier "radeon"
        Driver "ati"
