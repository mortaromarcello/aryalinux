...
SOURCE_ONLY=n
DESCRIPTION=" The Xorg libXaw library provide library routines that are used within all X Window applications."
SECTION="x"
VERSION=1.0.13
NAME="libXaw"
PKGNAME=$NAME
...
function build() {
    ...
    if [ ! -z $URL ]; then
        wget -nc http://ftp.x.org/pub/individual/lib/libXaw-1.0.13.tar.bz2
