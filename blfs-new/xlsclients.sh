...
function build() {
    ...
    cd $SRC
    URL=http://ftp.x.org/pub/individual/app/xlsclients-1.1.3.tar.bz2
    if [ ! -z $URL ]; then
        wget -nc http://ftp.x.org/pub/individual/app/xlsclients-1.1.3.tar.bz2
