...
SOURCE_ONLY=n
DESCRIPTION=" The Xorg xtrans library provide library routines that are used within all X Window applications."
SECTION="x"
VERSION=1.3.5
NAME="xtrans"
PKGNAME=$NAME
...
function build() {
    ...
    if [ ! -z $URL ]; then
        wget -nc http://ftp.x.org/pub/individual/lib/xtrans-1.3.5.tar.bz2
