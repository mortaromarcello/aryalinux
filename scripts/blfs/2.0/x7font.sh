...
ln -sfv $XORG_PREFIX/share/fonts/X11/OTF /usr/share/fonts/X11-OTF &&
ln -sfv $XORG_PREFIX/share/fonts/X11/TTF /usr/share/fonts/X11-TTF
ENDOFFILE
...
echo "x7font=>`date`" | sudo tee -a $INSTALLED_LIST