...
wget -nc http://download.kde.org/stable/frameworks/5.7/kactivities-5.7.0.tar.xz
wget -nc ftp://ftp.kde.org/pub/kde/stable/frameworks/5.7/kactivities-5.7.0.tar.xz


TARBALL=kactivities-5.7.0.tar.xz
