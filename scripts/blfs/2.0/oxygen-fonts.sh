...
wget -nc http://download.kde.org/stable/plasma/5.2.0/oxygen-fonts-5.2.0.tar.xz
wget -nc ftp://ftp.kde.org/pub/kde/stable/plasma/5.2.0/oxygen-fonts-5.2.0.tar.xz


TARBALL=oxygen-fonts-5.2.0.tar.xz
