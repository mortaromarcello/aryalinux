...
wget -nc http://www.linuxfromscratch.org/patches/blfs/svn/dhcp-4.3.4-client_script-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/dhcp/dhcp-4.3.4-client_script-1.patch
