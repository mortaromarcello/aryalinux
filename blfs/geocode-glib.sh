...
wget -nc http://www.linuxfromscratch.org/patches/blfs/systemd/geocode-glib-3.18.1-fix_icon_installation-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/geocode-glib/geocode-glib-3.18.1-fix_icon_installation-1.patch
wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/geocode-glib/geocode-glib-3.18.1.tar.xz || wget -nc http://ftp.gnome.org/pub/gnome/sources/geocode-glib/3.18/geocode-glib-3.18.1.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/geocode-glib/geocode-glib-3.18.1.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/geocode-glib/geocode-glib-3.18.1.tar.xz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/geocode-glib/geocode-glib-3.18.1.tar.xz || wget -nc ftp://ftp.gnome.org/pub/gnome/sources/geocode-glib/3.18/geocode-glib-3.18.1.tar.xz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/geocode-glib/geocode-glib-3.18.1.tar.xz
