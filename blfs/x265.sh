...
wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/x265/x265_1.9.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/x265/x265_1.9.tar.gz || wget -nc https://bitbucket.org/multicoreware/x265/downloads/x265_1.9.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/x265/x265_1.9.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/x265/x265_1.9.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/x265/x265_1.9.tar.gz
