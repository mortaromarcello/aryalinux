...
wget -nc http://www.linuxfromscratch.org/patches/blfs/7.10/x265_2.0-enable_static-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/x265/x265_2.0-enable_static-1.patch
