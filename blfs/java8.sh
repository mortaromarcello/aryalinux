...
sudo install -v -dm755 /opt/OpenJDK-1.8.0.92-bin &&
sudo mv -v * /opt/OpenJDK-1.8.0.92-bin         &&
sudo chown -R root:root /opt/OpenJDK-1.8.0.92-bin

sudo ln -sfnv OpenJDK-1.8.0.92-bin /opt/jdk
