...
wget -nc http://www.linuxfromscratch.org/patches/blfs/7.10/faac-1.28-glibc_fixes-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/faac/faac-1.28-glibc_fixes-1.patch
