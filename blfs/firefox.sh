...
patch -Np1 -i ../firefox-47.0.1-gcc6-1.patch


patch -Np1 -i ../firefox-47.0.1-gtk320-1.patch


patch -Np1 -i ../firefox-47.0.1-system_graphite2_harfbuzz-1.patch
...
chown -R 0:0 /usr/lib/firefox-47.0.1   &&
mkdir -pv    /usr/lib/mozilla/plugins  &&
ln    -sfv   ../../mozilla/plugins /usr/lib/firefox-47.0.1/browser &&
...
StartupNotify=true
EOF
ln -sfv /usr/lib/firefox-47.0.1/browser/icons/mozicon128.png \
