...
wget -nc http://www.linuxfromscratch.org/patches/downloads/bind/bind-9.10.3-P3-use_iproute2-1.patch || wget -nc http://www.linuxfromscratch.org/patches/blfs/systemd/bind-9.10.3-P3-use_iproute2-1.patch
