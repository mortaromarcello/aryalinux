...
wget -nc http://www.linuxfromscratch.org/patches/downloads/bind/bind-9.10.4-P2-use_iproute2-1.patch || wget -nc http://www.linuxfromscratch.org/patches/blfs/svn/bind-9.10.4-P2-use_iproute2-1.patch
