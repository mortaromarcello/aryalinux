...
URL=ftp://ftp.isc.org/isc/bind9/9.10.4-P1/bind-9.10.4-P1.tar.gz

wget -nc http://www.linuxfromscratch.org/patches/blfs/systemd/bind-9.10.4-P1-use_iproute2-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/bind/bind-9.10.4-P1-use_iproute2-1.patch
wget -nc ftp://ftp.isc.org/isc/bind9/9.10.4-P1/bind-9.10.4-P1.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/bind/bind-9.10.4-P1.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/bind/bind-9.10.4-P1.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/bind/bind-9.10.4-P1.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/bind/bind-9.10.4-P1.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/bind/bind-9.10.4-P1.tar.gz
...
patch -Np1 -i ../bind-9.10.4-P1-use_iproute2-1.patch
