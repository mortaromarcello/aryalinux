...
wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/bind/bind-9.10.3-P3.tar.gz || wget -nc ftp://ftp.isc.org/isc/bind9/9.10.3-P3/bind-9.10.3-P3.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/bind/bind-9.10.3-P3.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/bind/bind-9.10.3-P3.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/bind/bind-9.10.3-P3.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/bind/bind-9.10.3-P3.tar.gz
wget -nc http://www.linuxfromscratch.org/patches/blfs/systemd/bind-9.10.3-P3-use_iproute2-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/bind/bind-9.10.3-P3-use_iproute2-1.patch
...
patch -Np1 -i ../bind-9.10.3-P3-use_iproute2-1.patch
...
install -v -m755 -d /usr/share/doc/bind-9.10.3-P3/{arm,misc} &&
install -v -m644    doc/arm/*.html \
                    /usr/share/doc/bind-9.10.3-P3/arm &&
install -v -m644    doc/misc/{dnssec,ipv6,migrat*,options,rfc-compliance,roadmap,sdb} \
                    /usr/share/doc/bind-9.10.3-P3/misc
