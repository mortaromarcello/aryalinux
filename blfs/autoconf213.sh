...
wget -nc http://www.linuxfromscratch.org/patches/downloads/autoconf/autoconf-2.13-consolidated_fixes-1.patch || wget -nc http://www.linuxfromscratch.org/patches/blfs/7.10/autoconf-2.13-consolidated_fixes-1.patch
