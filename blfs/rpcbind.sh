...
wget -nc http://www.linuxfromscratch.org/patches/downloads/rpcbind/rpcbind-0.2.3-tirpc_fix-1.patch || wget -nc http://www.linuxfromscratch.org/patches/blfs/systemd/rpcbind-0.2.3-tirpc_fix-1.patch
