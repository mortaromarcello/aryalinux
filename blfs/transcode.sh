...
wget -nc http://www.linuxfromscratch.org/patches/blfs/systemd/transcode-1.1.7-ffmpeg3-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/transcode/transcode-1.1.7-ffmpeg3-1.patch
