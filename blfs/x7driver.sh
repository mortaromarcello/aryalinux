...
wget -nc http://www.freedesktop.org/software/libinput/libinput-1.4.1.tar.xz
...
sudo tee rootscript.sh << "ENDOFROOTSCRIPT"
install -v -dm755 $XORG_PREFIX/share/doc/libinput-1.4.1 &&
cp -rv doc/html/* $XORG_PREFIX/share/doc/libinput-1.4.1
ENDOFROOTSCRIPT
sudo chmod 755 rootscript.sh
sudo ./rootscript.sh
sudo rm rootscript.sh
