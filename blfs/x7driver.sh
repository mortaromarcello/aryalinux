...
URL=http://ftp.x.org/pub/individual/driver/xf86-input-evdev-2.10.1.tar.bz2

wget -nc http://ftp.x.org/pub/individual/driver/xf86-input-evdev-2.10.1.tar.bz2
wget -nc ftp://ftp.x.org/pub/individual/driver/xf86-input-evdev-2.10.1.tar.bz2
...
URL=http://downloads.sourceforge.net/linuxwacom/xf86-input-wacom-0.31.0.tar.bz2

wget -nc http://downloads.sourceforge.net/linuxwacom/xf86-input-wacom-0.31.0.tar.bz2
...
URL=http://ftp.x.org/pub/individual/driver/xf86-video-ati-7.6.1.tar.bz2

wget -nc http://ftp.x.org/pub/individual/driver/xf86-video-ati-7.6.1.tar.bz2
wget -nc ftp://ftp.x.org/pub/individual/driver/xf86-video-ati-7.6.1.tar.bz2
