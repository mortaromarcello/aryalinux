...
wget -nc http://www.linuxfromscratch.org/patches/blfs/systemd/frei0r-snapshot-27-01-15-gcc5_fix-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/frei0r-snapshot/frei0r-snapshot-27-01-15-gcc5_fix-1.patch
wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/frei0r/frei0r-snapshot-27-01-15.tar.gz || wget -nc https://files.dyne.org/frei0r/snapshots/frei0r-snapshot-27-01-15.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/frei0r/frei0r-snapshot-27-01-15.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/frei0r/frei0r-snapshot-27-01-15.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/frei0r/frei0r-snapshot-27-01-15.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/frei0r/frei0r-snapshot-27-01-15.tar.gz
