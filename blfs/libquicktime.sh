...
wget -nc http://www.linuxfromscratch.org/patches/blfs/7.10/libquicktime-1.2.4-ffmpeg3-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/libquicktime/libquicktime-1.2.4-ffmpeg3-1.patch
