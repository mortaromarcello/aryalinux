...
wget -nc http://www.linuxfromscratch.org/patches/blfs/7.10/w3m-0.5.3-bdwgc72-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/w3m/w3m-0.5.3-bdwgc72-1.patch
