...
wget -nc http://www.linuxfromscratch.org/patches/downloads/inkscape/inkscape-0.91-testfiles-1.patch || wget -nc http://www.linuxfromscratch.org/patches/blfs/7.10/inkscape-0.91-testfiles-1.patch
