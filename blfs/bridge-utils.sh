...
wget -nc http://www.linuxfromscratch.org/patches/blfs/7.10/bridge-utils-1.5-linux_3.8_fix-2.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/bridge-utils/bridge-utils-1.5-linux_3.8_fix-2.patch
