...
if [ ! -z $URL ]
then
wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/shadow/shadow-4.2.1.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/shadow/shadow-4.2.1.tar.xz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/shadow/shadow-4.2.1.tar.xz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/shadow/shadow-4.2.1.tar.xz || wget -nc http://pkg-shadow.alioth.debian.org/releases/shadow-4.2.1.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/shadow/shadow-4.2.1.tar.xz
