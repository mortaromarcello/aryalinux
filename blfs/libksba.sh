...
if [ ! -z $URL ]
then
wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/libksba/libksba-1.3.5.tar.bz2 || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/libksba/libksba-1.3.5.tar.bz2 || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/libksba/libksba-1.3.5.tar.bz2 || wget -nc ftp://ftp.gnupg.org/gcrypt/libksba/libksba-1.3.5.tar.bz2 || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/libksba/libksba-1.3.5.tar.bz2 || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/libksba/libksba-1.3.5.tar.bz2
