...
wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/tripwire/tripwire-2.4.2.2-src.tar.bz2 || wget -nc http://downloads.sourceforge.net/tripwire/tripwire-2.4.2.2-src.tar.bz2 || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/tripwire/tripwire-2.4.2.2-src.tar.bz2 || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/tripwire/tripwire-2.4.2.2-src.tar.bz2 || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/tripwire/tripwire-2.4.2.2-src.tar.bz2 || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/tripwire/tripwire-2.4.2.2-src.tar.bz2
