...
wget -nc http://ftp.postgresql.org/pub/source/v9.5.1/postgresql-9.5.1.tar.bz2 || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/postgresql/postgresql-9.5.1.tar.bz2 || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/postgresql/postgresql-9.5.1.tar.bz2 || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/postgresql/postgresql-9.5.1.tar.bz2 || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/postgresql/postgresql-9.5.1.tar.bz2 || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/postgresql/postgresql-9.5.1.tar.bz2 || wget -nc ftp://ftp.postgresql.org/pub/source/v9.5.1/postgresql-9.5.1.tar.bz2
