...
wget -nc http://www.linuxfromscratch.org/patches/downloads/openjade/openjade-1.3.2-gcc_4.6-1.patch || wget -nc http://www.linuxfromscratch.org/patches/blfs/systemd/openjade-1.3.2-gcc_4.6-1.patch
