...
wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/simpleburn/simpleburn-1.8.1.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/simpleburn/simpleburn-1.8.1.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/simpleburn/simpleburn-1.8.1.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/simpleburn/simpleburn-1.8.1.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/simpleburn/simpleburn-1.8.1.tar.gz || wget -nc http://simpleburn.tuxfamily.org/IMG/gz/simpleburn-1.8.1.tar.gz
