...
if [ ! -z $URL ]
then
wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/giflib/giflib-5.1.4.tar.bz2 || wget -nc http://downloads.sourceforge.net/giflib/giflib-5.1.4.tar.bz2 || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/giflib/giflib-5.1.4.tar.bz2 || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/giflib/giflib-5.1.4.tar.bz2 || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/giflib/giflib-5.1.4.tar.bz2 || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/giflib/giflib-5.1.4.tar.bz2
