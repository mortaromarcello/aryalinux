...
wget -nc http://www.linuxfromscratch.org/patches/blfs/7.10/webkitgtk-2.4.11-gcc6-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/webkit/webkitgtk-2.4.11-gcc6-1.patch
