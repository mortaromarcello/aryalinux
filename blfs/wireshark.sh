...
wget -nc http://www.linuxfromscratch.org/patches/downloads/wireshark/wireshark-2.0.5-lua_5_3_1-1.patch || wget -nc http://www.linuxfromscratch.org/patches/blfs/svn/wireshark-2.0.5-lua_5_3_1-1.patch
