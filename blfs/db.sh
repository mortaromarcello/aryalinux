...
if [ ! -z $URL ]
then
wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/db/db-6.2.23.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/db/db-6.2.23.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/db/db-6.2.23.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/db/db-6.2.23.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/db/db-6.2.23.tar.gz || wget -nc http://download.oracle.com/berkeley-db/db-6.2.23.tar.gz
