...
wget -nc http://www.linuxfromscratch.org/patches/downloads/mupdf/mupdf-1.9-upstream_fix-1.patch || wget -nc http://www.linuxfromscratch.org/patches/blfs/7.10/mupdf-1.9-upstream_fix-1.patch
...
wget -nc http://www.linuxfromscratch.org/patches/downloads/mupdf/mupdf-1.9-openjpeg21-1.patch || wget -nc http://www.linuxfromscratch.org/patches/blfs/7.10/mupdf-1.9-openjpeg21-1.patch
