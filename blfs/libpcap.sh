...
wget -nc http://www.linuxfromscratch.org/patches/downloads/libpcap/libpcap-1.7.4-enable_bluetooth-1.patch || wget -nc http://www.linuxfromscratch.org/patches/blfs/systemd/libpcap-1.7.4-enable_bluetooth-1.patch
