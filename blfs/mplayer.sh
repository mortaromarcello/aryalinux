...
wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/MPlayer/mplayer-SVN-r37561.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/MPlayer/mplayer-SVN-r37561.tar.xz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/MPlayer/mplayer-SVN-r37561.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/MPlayer/mplayer-SVN-r37561.tar.xz || wget -nc http://anduin.linuxfromscratch.org/BLFS/other/mplayer-SVN-r37561.tar.xz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/MPlayer/mplayer-SVN-r37561.tar.xz
