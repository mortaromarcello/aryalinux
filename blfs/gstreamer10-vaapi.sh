...
if [ ! -z $URL ]
then
wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/gstreamer-vaapi/gstreamer-vaapi-1.8.3.tar.xz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/gstreamer-vaapi/gstreamer-vaapi-1.8.3.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/gstreamer-vaapi/gstreamer-vaapi-1.8.3.tar.xz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/gstreamer-vaapi/gstreamer-vaapi-1.8.3.tar.xz || wget -nc http://gstreamer.freedesktop.org/src/gstreamer-vaapi/gstreamer-vaapi-1.8.3.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/gstreamer-vaapi/gstreamer-vaapi-1.8.3.tar.xz
