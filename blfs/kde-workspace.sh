...
wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/kde/kde-workspace-4.11.20.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/kde/kde-workspace-4.11.20.tar.xz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/kde/kde-workspace-4.11.20.tar.xz || wget -nc ftp://ftp.kde.org/pub/kde/stable/applications/15.04.2/src/kde-workspace-4.11.20.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/kde/kde-workspace-4.11.20.tar.xz || wget -nc http://download.kde.org/stable/applications/15.04.2/src/kde-workspace-4.11.20.tar.xz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/kde/kde-workspace-4.11.20.tar.xz
