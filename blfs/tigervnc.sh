...
wget -nc http://www.linuxfromscratch.org/patches/blfs/7.10/tigervnc-1.6.0-gethomedir-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/tigervnc/tigervnc-1.6.0-gethomedir-1.patch
...
wget -nc http://www.linuxfromscratch.org/patches/blfs/7.10/tigervnc-1.6.0-xorg118-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/tigervnc/tigervnc-1.6.0-xorg118-1.patch
