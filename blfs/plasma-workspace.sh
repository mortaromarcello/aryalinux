...
wget -nc ftp://ftp.kde.org/pub/kde/stable/plasma/5.3.1/plasma-workspace-5.3.1.tar.xz || wget -nc http://download.kde.org/stable/plasma/5.3.1/plasma-workspace-5.3.1.tar.xz
