...
if [ ! -z $URL ]
then
wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/boost/boost_1_62_0.tar.bz2 || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/boost/boost_1_62_0.tar.bz2 || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/boost/boost_1_62_0.tar.bz2 || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/boost/boost_1_62_0.tar.bz2 || wget -nc http://downloads.sourceforge.net/project/boost/boost/1.62.0/boost_1_62_0.tar.bz2 || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/boost/boost_1_62_0.tar.bz2
