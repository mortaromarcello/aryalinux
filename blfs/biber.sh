...
wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/biblatex/biblatex-3.4.tds.tgz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/biblatex/biblatex-3.4.tds.tgz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/biblatex/biblatex-3.4.tds.tgz || wget -nc http://sourceforge.net/projects/biblatex/files/biblatex-3.4/biblatex-3.4.tds.tgz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/biblatex/biblatex-3.4.tds.tgz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/biblatex/biblatex-3.4.tds.tgz
...
tar -xf ../biblatex-3.4.tds.tgz -C /opt/texlive/2015/texmf-dist &&
texhash &&
./Build install
